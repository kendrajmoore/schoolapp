...
function traverser(args) {
    ...
    me.context = function() {
		return {
			...
			enterScope: function(node) {
                ...
                scope.temp = function(n) {
                    return "__t" + __this.ast.ctemp++ + (n ? '_'+n : '');
                };
    ...
    me._forInOfStmt = function(stmt, context) {
    ...
    me.returnStmt = function(stmt, context) {
    ...
    me.quasiLiteral = function(x) { throw new Error('Unhandled quasi literal!') };

    me.spreadElement = function(expr, context) {
		return me.unary(expr, context);
	}
...
traverser.explicit = function (name, args, exceptions) {
    ...
    if ('forInOfStmt' in args)
        exceptions = exceptions.concat(['forOfStmt', 'forInStmt']);
